...
class GoalFeasibilityReasonFormatterTest {
    ...
    void 예상_자산이_목표보다_적으면_부족_문구를_반환한다() {
        ...
        assertEquals(
                "3개월 후 예상 자산은 약 8,000만원이에요. 목표 금액 1억원 대비 약 2,000만원 모자라요.", reason);
    }
    ...
    void 만원_단위_숫자는_반올림_없이_그대로_표시한다() {
        ...
        assertEquals(
                "3개월 후 예상 자산은 약 8,912만원이에요. 목표 금액 1억원 대비 약 1,088만원 모자라요.", reason);
    }
    ...
    void 만원_미만_소수점은_버린다() {
        ...
        assertEquals("1개월 후 예상 자산은 약 10만원이에요. 목표 금액 100만원 대비 약 89만원 모자라요.", reason);
    }
